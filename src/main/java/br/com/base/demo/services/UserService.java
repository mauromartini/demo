...
public class UserService {
    ...
    User user1 = new User(1, "mkyong", "password111", "mkyong@yahoo.com");
    User user2 = new User(2, "yflow", "password222", "yflow@yahoo.com");
    User user3 = new User(3, "laplap", "password333", "mkyong@yahoo.com");
